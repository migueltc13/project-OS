...
\chapter{Arquitetura do Serviço}
    ...
    \section{Descrição dos Módulos Desenvolvidos}
        ...
        O orquestrador é módulo principal do serviço, sendo responsável por:
        \begin{itemize}
            \item Fazer o \textit{parsing} dos argumentos da linha de comandos;
            \item Criar o FIFO do servidor;
            \item Receber os pedidos dos clientes enviados pelo FIFO do servidor e lidar com estes adequadamente;
        ...
        O orquestrador pode receber quatro tipos de pedidos:
        \begin{itemize}
            ...
            \item \textit{\textbf{STATUS}} - Pedido para consultar o estado de uma tarefa.
            O orquestrador envia uma resposta ao cliente com o estado da tarefa através do seu FIFO.
            ...
            O orquestrador continua a correr até receber este pedido de um cliente, ou até receber um sinal do sistema operativo para interromper/terminar.
        \end{itemize}
