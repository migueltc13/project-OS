...
\begin{abstract}
    ...
    foi proposto o desenvolvimento de um serviço de execução de tarefas assíncronas,
    ...
    políticas de escalonamento implementadas e os testes realizados e as respectivas reflexões.
\end{abstract}
\end{flushleft}
