...
\backgroundsetup{
    ...
    contents={
        \begin{tikzpicture}[remember picture,overlay]
            ...
            \node[color=white] at (-6.85,-12) {\bfseries {\fontsize{120}{60} \textsf{S}}};
            \node[color=titlepagecolor] at (-3.85,-12) {\bfseries {\fontsize{120}{60} \textsf{O}}};
        \end{tikzpicture}
    }
}
...
%% UniPic
\newcommand{\UniPic}{\includegraphics[scale=0.36]{images/eeum.png}}
