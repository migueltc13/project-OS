...
char $\ast$ \mbox{\hyperlink{orchestrator_8c_a6f474b6fdb25ba074b3db104520b7a67}{policy\+\_\+to\+\_\+string}} (int policy)
\begin{DoxyCompactList}\small\item\em Convert the scheduling policy to a string. \end{DoxyCompactList}\item 
...
\hline
\end{DoxyParams}
\mbox{\Hypertarget{orchestrator_8c_a6f474b6fdb25ba074b3db104520b7a67}\label{orchestrator_8c_a6f474b6fdb25ba074b3db104520b7a67}} 
\index{orchestrator.c@{orchestrator.c}!policy\_to\_string@{policy\_to\_string}}
\index{policy\_to\_string@{policy\_to\_string}!orchestrator.c@{orchestrator.c}}
\doxysubsubsection{\texorpdfstring{policy\_to\_string()}{policy\_to\_string()}}
{\footnotesize\ttfamily char $\ast$ policy\+\_\+to\+\_\+string (\begin{DoxyParamCaption}\item[{int}]{policy }\end{DoxyParamCaption})}
...
\begin{DoxyParams}{Parameters}
{\em policy} & The scheduling policy \\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
The scheduling policy as a string 
\end{DoxyReturn}
...
If there\textquotesingle{}s an available scheduled request, the function will send a message to the client with the task number and the status of the request -\/ either executing or scheduled.
